                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                <button
                                    ...
                                    className="flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white font-semibold py-4 rounded-xl transition-colors shadow-md hover:shadow-lg"
                                >
                                    Start Exercise
                                </button>
                            </div>
                    ...
                    {step === 3 && results && (
                        <div className="space-y-6">
                            <div className="text-center pb-4">
                                ...
                                <h4 className="text-3xl font-bold text-gray-800 mb-2">Great Job!</h4>
                                <p className="text-gray-600">You completed the exercise successfully</p>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-8 border-2 border-emerald-200 text-center">
                                    <p className="text-sm text-gray-600 mb-2 font-medium">Fluency Score</p>
                                    <p className="text-6xl font-bold text-emerald-600">{results.fluencyScore}%</p>
                                </div>

                                {/* Stutters Detected */}
                                <div className="bg-gray-50 rounded-2xl p-8 border-2 border-gray-200 text-center">
                                    <p className="text-sm text-gray-600 mb-2 font-medium">Stutters Detected</p>
                                    <p className="text-6xl font-bold text-gray-800">{results.stuttersDetected}</p>
                                </div>
                            </div>

                            {/* Timeline */}
                            <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                                <p className="text-sm text-gray-600 mb-4 font-medium">Speech Timeline</p>
                            ...
                            <button
                                onClick={handleContinue}
                                className="w-full bg-emerald-500 hover:bg-emerald-600 text-white font-semibold py-4 rounded-xl transition-colors shadow-md hover:shadow-lg"
                            >
                                Continue
                            </button>
                        </div>
